...
class AutomovilTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        renault = Auto(marca="renault", placa="JXL539", modelo=1970, kilometraje=3200, color="negro", cilindraje=2000, combustible="gasolina")
        mini = Auto(marca="mini", placa="JXL539", modelo=1970, kilometraje=3200, color="negro", cilindraje=2000, combustible="gasolina")
